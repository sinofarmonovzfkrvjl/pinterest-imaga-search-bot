...
def get_random_pinterest_image_url():
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36"
    }
    
    # Pinterest's explore page where random images appear
    url = "https://www.pinterest.com/explore/"
    ...
    # Extract URLs from the <img> tags
    image_urls = [img['src'] for img in image_tags if 'https://' in img['src']]
